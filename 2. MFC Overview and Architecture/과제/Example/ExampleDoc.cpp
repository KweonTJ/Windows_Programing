...
// ExampleDoc.cpp: CExampleDoc 클래스의 구현
//
...
CExampleDoc::CExampleDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CExampleDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CExampleDoc::InitializeSearchContent()
{
...
void CExampleDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
