...
// Example3View.h: CExample3View 클래스의 인터페이스
//

#pragma once


class CExample3View : public CFormView
{
protected: // serialization에서만 만들어집니다.
	CExample3View() noexcept;
	DECLARE_DYNCREATE(CExample3View)

public:
#ifdef AFX_DESIGN_TIME
	enum{ IDD = IDD_EXAMPLE3_FORM };
#endif
...
#ifndef _DEBUG  // Example3View.cpp의 디버그 버전
