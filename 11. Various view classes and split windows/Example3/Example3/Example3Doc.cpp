...
// Example3Doc.cpp: CExample3Doc 클래스의 구현
//
...
CExample3Doc::CExample3Doc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CExample3Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CExample3Doc::InitializeSearchContent()
{
...
void CExample3Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
