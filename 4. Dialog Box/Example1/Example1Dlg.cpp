...
BEGIN_MESSAGE_MAP(CExample1Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_LBN_SELCHANGE(IDC_LIST_OUTPUT, &CExample1Dlg::OnLbnSelchangeListOutput)
	ON_COMMAND(IDC_RADIO1, &CExample1Dlg::OnRadio1)
	ON_COMMAND(IDC_RADIO2, &CExample1Dlg::OnRadio2)
	ON_BN_CLICKED(IDC_CHECK1, &CExample1Dlg::OnClickedCheck1)
	ON_BN_CLICKED(IDC_CHECK2, &CExample1Dlg::OnClickedCheck2)
	ON_BN_CLICKED(IDC_BUTTON_ADD, &CExample1Dlg::OnClickedButtonAdd)
	ON_BN_CLICKED(IDC_BUTTON_INSERT, &CExample1Dlg::OnClickedButtonInsert)
	ON_BN_CLICKED(IDC_BUTTON_DELETE, &CExample1Dlg::OnClickedButtonDelete)
END_MESSAGE_MAP()
...
void CExample1Dlg::OnLbnSelchangeListOutput()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}

void CExample1Dlg::UpdateComboBox()
{
	// TODO: 여기에 구현 코드 추가.
...
void CExample1Dlg::OnClickedCheck1()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CExample1Dlg::OnClickedCheck2()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CExample1Dlg::OnClickedButtonAdd()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
...
void CExample1Dlg::OnClickedButtonInsert()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CString strSelText;
...
void CExample1Dlg::OnClickedButtonDelete()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	int index = m_cbListItem.GetCurSel();
	if (index != CB_ERR)
